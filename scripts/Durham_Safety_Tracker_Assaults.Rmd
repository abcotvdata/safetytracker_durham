...
<div class="card" style="background-color:#99a0a5;">
<p>Average Aggravated Assaults<br>2019 to 2021<br>
...
<div class="card" style="background-color:#99a0a5;">
<p>Average Aggravated Assault Rate<br>2019 to 2021<br>
...
<subhead>A closer look at Durham aggravated assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC11's data team looked at the Durham Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
durham_assault_map <- leaflet(assaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Aggravated assaults year by year in Durham" aria-label="Column Chart" id="datawrapper-chart-Jx1UI" src="https://datawrapper.dwcdn.net/Jx1UI/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
