...
<div class="card" style="background-color:#99a0a5;">
<p>Average Sexual Assaults<br>2019 to 2021<br>
...
<div class="card" style="background-color:#99a0a5;">
<p>Average Sexual Assault Rate<br>2019 to 2021<br>
...
<subhead>A closer look at Durham sexual assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC11's data team looked at the Durham Police Department's public data about sexual assault reports by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
durham_sexassault_map <- leaflet(sexassaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
durham_sexassault_map
```
<br>
<br>
<iframe title="Sexual Assaults year by year in Durham" aria-label="Column Chart" id="datawrapper-chart-k9hHF" src="https://datawrapper.dwcdn.net/k9hHF/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
<br>
<br>
<!-- <subhead>Violent crime rate comparisons </subhead> -->
<iframe title="2021 violent crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-UUR7i" src="https://datawrapper.dwcdn.net/UUR7i/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>