...
## load stored recent and past crime files
past_crime_durham <- readRDS("scripts/rds/past_crime_durham.RDS")
recent_crime_durham <- readRDS("scripts/rds/recent_crime_durham.RDS")
