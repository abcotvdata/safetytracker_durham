...
<subhead>A closer look at Durham burglaries neighborhood by neighborhood</subhead>
...
durham_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
