---
title: "ABC13 Durham Neighborhood Safety Tracker"
# author: "John Kelly"
# date: Sys.time()
...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC13 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_philadelphia/raw/main/docs/banner_placeholder.png)
```{css, echo=FALSE}
...
<subhead>A closer look at Philadelphia burglaries neighborhood by neighborhood</subhead>
...
philadelphia_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
  htmlwidgets::onRender("function(el, x) {
L.control.zoom({ position: 'topright' }).addTo(this)
}") %>%
  setView(-75.165, 39.9526, zoom = 11.5) %>% 
...
philadelphia_burglary_map
```
<br>
<br>
<iframe title="Residential and non-residential burglaries by month since 2019" aria-label="Stacked Column Chart" id="datawrapper-chart-1ZBAA" src="https://datawrapper.dwcdn.net/1ZBAA/5/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<!-- <subhead>Risk of property crime in major cities</subhead> -->
<br>
<br>
<iframe title="2021 property crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-hXLIV" src="https://datawrapper.dwcdn.net/hXLIV/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>