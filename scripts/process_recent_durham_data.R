...
pdftext <- pdf_text("data/source/recent/November 26 2022 Weekly Period to Date Table.pdf") %>% strsplit(split = "\n")

# Grab individual text values for each of 5 districts plus citywide
# Dist 1
rawtext1 <- pdftext[[1]][59] %>% trimws()
rawtext2 <- pdftext[[1]][60] %>% trimws()
rawtext3 <- pdftext[[1]][61] %>% trimws()
rawtext4 <- pdftext[[1]][62] %>% trimws()
rawtext5 <- pdftext[[1]][63] %>% trimws()
rawtext6 <- pdftext[[1]][69] %>% trimws()
rawtext7 <- pdftext[[1]][70] %>% trimws()
rawtext8 <- pdftext[[1]][74] %>% trimws()
# Dist 2
rawtext9 <- pdftext[[1]][77] %>% trimws()
rawtext10 <- pdftext[[1]][78] %>% trimws()
rawtext11 <- pdftext[[1]][79] %>% trimws()
rawtext12 <- pdftext[[1]][80] %>% trimws()
rawtext13 <- pdftext[[1]][81] %>% trimws()
rawtext14 <- pdftext[[1]][87] %>% trimws()
rawtext15 <- pdftext[[1]][88] %>% trimws()
rawtext16 <- pdftext[[1]][92] %>% trimws()
# Dist 3
rawtext17 <- pdftext[[1]][95] %>% trimws()
rawtext18 <- pdftext[[1]][96] %>% trimws()
rawtext19 <- pdftext[[1]][97] %>% trimws()
rawtext20 <- pdftext[[1]][98] %>% trimws()
rawtext21 <- pdftext[[1]][99] %>% trimws()
rawtext22 <- pdftext[[1]][105] %>% trimws()
rawtext23 <- pdftext[[1]][106] %>% trimws()
rawtext24 <- pdftext[[1]][110] %>% trimws()
# Dist 4
rawtext25 <- pdftext[[2]][59] %>% trimws()
rawtext26 <- pdftext[[2]][60] %>% trimws()
rawtext27 <- pdftext[[2]][61] %>% trimws()
rawtext28 <- pdftext[[2]][62] %>% trimws()
rawtext29 <- pdftext[[2]][63] %>% trimws()
rawtext30 <- pdftext[[2]][69] %>% trimws()
rawtext31 <- pdftext[[2]][70] %>% trimws()
rawtext32 <- pdftext[[2]][74] %>% trimws()
# Dist 5
rawtext33 <- pdftext[[2]][77] %>% trimws()
rawtext34 <- pdftext[[2]][78] %>% trimws()
rawtext35 <- pdftext[[2]][79] %>% trimws()
rawtext36 <- pdftext[[2]][80] %>% trimws()
rawtext37 <- pdftext[[2]][81] %>% trimws()
rawtext38 <- pdftext[[2]][87] %>% trimws()
rawtext39 <- pdftext[[2]][88] %>% trimws()
rawtext40 <- pdftext[[2]][92] %>% trimws()
# Citywide
rawtext41 <- pdftext[[2]][95] %>% trimws()
rawtext42 <- pdftext[[2]][96] %>% trimws()
rawtext43 <- pdftext[[2]][97] %>% trimws()
rawtext44 <- pdftext[[2]][98] %>% trimws()
rawtext45 <- pdftext[[2]][99] %>% trimws()
rawtext46 <- pdftext[[2]][105] %>% trimws()
rawtext47 <- pdftext[[2]][106] %>% trimws()
rawtext48 <- pdftext[[2]][110] %>% trimws()
