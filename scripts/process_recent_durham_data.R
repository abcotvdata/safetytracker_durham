...
pdftext <- pdf_text("data/source/recent/December 10 2022 Weekly Period to Date Table.pdf") %>% strsplit(split = "\n")

# Grab individual text values for each of 5 districts plus citywide
# Dist 1
rawtext1 <- pdftext[[1]][55] %>% trimws()
rawtext2 <- pdftext[[1]][56] %>% trimws()
rawtext3 <- pdftext[[1]][57] %>% trimws()
rawtext4 <- pdftext[[1]][58] %>% trimws()
rawtext5 <- pdftext[[1]][59] %>% trimws()
rawtext6 <- pdftext[[1]][65] %>% trimws()
rawtext7 <- pdftext[[1]][66] %>% trimws()
rawtext8 <- pdftext[[1]][70] %>% trimws()
# Dist 2
rawtext9 <- pdftext[[1]][73] %>% trimws()
rawtext10 <- pdftext[[1]][74] %>% trimws()
rawtext11 <- pdftext[[1]][75] %>% trimws()
rawtext12 <- pdftext[[1]][76] %>% trimws()
rawtext13 <- pdftext[[1]][77] %>% trimws()
rawtext14 <- pdftext[[1]][83] %>% trimws()
rawtext15 <- pdftext[[1]][84] %>% trimws()
rawtext16 <- pdftext[[1]][88] %>% trimws()
# Dist 3
rawtext17 <- pdftext[[1]][91] %>% trimws()
rawtext18 <- pdftext[[1]][92] %>% trimws()
rawtext19 <- pdftext[[1]][93] %>% trimws()
rawtext20 <- pdftext[[1]][94] %>% trimws()
rawtext21 <- pdftext[[1]][95] %>% trimws()
rawtext22 <- pdftext[[1]][101] %>% trimws()
rawtext23 <- pdftext[[1]][102] %>% trimws()
rawtext24 <- pdftext[[1]][106] %>% trimws()
# Dist 4
rawtext25 <- pdftext[[2]][55] %>% trimws()
rawtext26 <- pdftext[[2]][56] %>% trimws()
rawtext27 <- pdftext[[2]][57] %>% trimws()
rawtext28 <- pdftext[[2]][58] %>% trimws()
rawtext29 <- pdftext[[2]][59] %>% trimws()
rawtext30 <- pdftext[[2]][65] %>% trimws()
rawtext31 <- pdftext[[2]][66] %>% trimws()
rawtext32 <- pdftext[[2]][70] %>% trimws()
# Dist 5
rawtext33 <- pdftext[[2]][73] %>% trimws()
rawtext34 <- pdftext[[2]][74] %>% trimws()
rawtext35 <- pdftext[[2]][75] %>% trimws()
rawtext36 <- pdftext[[2]][76] %>% trimws()
rawtext37 <- pdftext[[2]][77] %>% trimws()
rawtext38 <- pdftext[[2]][83] %>% trimws()
rawtext39 <- pdftext[[2]][84] %>% trimws()
rawtext40 <- pdftext[[2]][88] %>% trimws()
# Citywide
rawtext41 <- pdftext[[2]][91] %>% trimws()
rawtext42 <- pdftext[[2]][92] %>% trimws()
rawtext43 <- pdftext[[2]][93] %>% trimws()
rawtext44 <- pdftext[[2]][94] %>% trimws()
rawtext45 <- pdftext[[2]][95] %>% trimws()
rawtext46 <- pdftext[[2]][101] %>% trimws()
rawtext47 <- pdftext[[2]][102] %>% trimws()
rawtext48 <- pdftext[[2]][106] %>% trimws()
