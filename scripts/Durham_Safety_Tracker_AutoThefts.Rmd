...
<div class="card" style="background-color:#99a0a5;">
<p>Average Auto Thefts<br>2019 to 2021<br>
...
<div class="card" style="background-color:#99a0a5;">
<p>Average Auto Theft Rate<br>2019 to 2021<br>
...
<subhead>A closer look at Philadelphia auto thefts by neighborhood</subhead>
...
philadelphia_autotheft_map <- leaflet(autothefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
philadelphia_autotheft_map
```
<br>
<br>
<iframe title="Vehicle thefts in Philadelphia month by month since 2019" aria-label="Column Chart" id="datawrapper-chart-eFeTQ" src="https://datawrapper.dwcdn.net/eFeTQ/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
