...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC11 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_durham/raw/main/docs/banner_placeholder.png)
...
One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's more than twice the likelihood of dying in a vehicle crash in North Carolina.

During the pandemic, a person's chance of being murdered in Durham rose to above the risk of a fatal traffic crash.
<br>
<br>
