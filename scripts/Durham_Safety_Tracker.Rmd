...
<div class="card" style="background-color:#99a0a5;">
<p>Average Homicides<br>2019 to 2021<br>
...
<div class="card" style="background-color:#99a0a5;">
<p>Average Homicide Rate<br>2019 to 2021<br>
<bignumber>`r murders_city$rate_prior3years`<br></bignumber><p>
Per 100,000 people</p>
</div>
</div>
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_21tolast12>=0," up"," down")` `r ifelse(murders_city$inc_21tolast12>=0,murders_city$inc_21tolast12,substring(murders_city$inc_21tolast12,2))`%</h8> compared to 2021, according to the latest data available from the Durham Police Department.
...
The city averaged <h8>`r round(murders_city$last12mos/12,0)`</h8> homicides a month over the last year. In 2019, that number was <h8>`r round(murders_city$total19/12,0)`</h8> per month.

One way to think about the danger: three years ago, the murder rate was <h8>`r murders_city$rate19`</h8> per 100,000 residents. During the pandemic, a person's chance of being murdered in Durham has risen to almost the same risk of being killed in a fatal traffic crash and it's now higher than the risk of dying of the flu or pneumonia in North Carolina.
<br>
<br>
<!-- <subhead>Risk of being murdered -->
<iframe title="Risk of homicide in Durham vs. other causes of death" aria-label="Bar Chart" id="datawrapper-chart-3O738" src="https://datawrapper.dwcdn.net/3O738/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="373" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
The risk is not the same neighborhood to neighborhood.

ABC11's data team looked at the Durham Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
durham_murder_map <- leaflet(murders_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Homicides year by year in Durham" aria-label="Column Chart" id="datawrapper-chart-9xLwh" src="https://datawrapper.dwcdn.net/9xLwh/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
<br>
<br>
<!-- <subhead> comparison to other cities chart </subhead> -->
<iframe title="2021 homicide rate comparison in select cities" aria-label="Bar Chart" id="datawrapper-chart-SbBRe" src="https://datawrapper.dwcdn.net/SbBRe/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="628" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>